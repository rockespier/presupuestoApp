...
namespace PresupuestoFamiliarApp.Migrations
{
    ...
    [Migration("20260224155318_AgregarCuentasPorCobrar")]
    partial class AgregarCuentasPorCobrar
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PresupuestoFamiliarApp.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NombreUsuario = "admin",
                            PasswordHash = "$2a$11$XFD3roOxRfhfyVahP2vQXuldztcOgIybDZTTq2SDkeHGCYwU5nKoS",
                            Rol = "Administrador"
                        });
                });
