...
namespace PresupuestoFamiliarApp.Migrations
{
    ...
    [Migration("20260223140021_ImplementarSeguridadUsuarios")]
    partial class ImplementarSeguridadUsuarios
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PresupuestoFamiliarApp.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EspacioId = 1,
                            NombreUsuario = "admin",
                            PasswordHash = "$2a$11$i6xmGH7IWFwQ3vXkK0OGluG8PF7DFLToDHNGksFhPCGEZMOx22jmq",
                            Rol = "Administrador"
                        });
                });
