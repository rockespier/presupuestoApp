...
namespace PresupuestoFamiliarApp.Migrations
{
    ...
    [Migration("20260309115851_AgregarMonedaADeudas")]
    partial class AgregarMonedaADeudas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PresupuestoFamiliarApp.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MonedaPreferida = 0,
                            NombreUsuario = "admin",
                            PasswordHash = "$2a$11$VnpKDMn4aqGwIDf0c/hUp.WBa8sbAEZ5X8YDKg/R8YDYub2Xa.GSa",
                            Rol = "Administrador",
