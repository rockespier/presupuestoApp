...
namespace PresupuestoFamiliarApp.Migrations
{
    ...
    [Migration("20260309112257_AgregarMonedaAMovimientoFijo")]
    partial class AgregarMonedaAMovimientoFijo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PresupuestoFamiliarApp.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MonedaPreferida = 0,
                            NombreUsuario = "admin",
                            PasswordHash = "$2a$11$Y.UbnZJrpmYhLDRZydBhKOnCdrsh13xg4gJtwUO53SnHjc72CXV06",
                            Rol = "Administrador",
