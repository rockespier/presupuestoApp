...
namespace PresupuestoFamiliarApp.Migrations
{
    ...
    [Migration("20260223140243_AjusteFinalSeguridad")]
    partial class AjusteFinalSeguridad
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PresupuestoFamiliarApp.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EspacioId = 1,
                            NombreUsuario = "admin",
                            PasswordHash = "$2a$11$hzA5MKXBItr7jt3rMP4FOODAoHCYw5QaGCE44esAfn56N0FS5TUBS",
                            Rol = "Administrador"
                        });
                });
