...
namespace PresupuestoFamiliarApp.Migrations
{
    ...
    [Migration("20260309103441_AgregarMonedaACategoriaYUsuario")]
    partial class AgregarMonedaACategoriaYUsuario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PresupuestoFamiliarApp.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MonedaPreferida = 0,
                            NombreUsuario = "admin",
                            PasswordHash = "$2a$11$C9nbaZCmDYuRVqAPZPX0ZOiTFauPypdAVBRuC0wkKDFLvf/ZP1MMm",
                            Rol = "Administrador",
