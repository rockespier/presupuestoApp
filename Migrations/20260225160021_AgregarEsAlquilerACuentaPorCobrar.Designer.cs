...
namespace PresupuestoFamiliarApp.Migrations
{
    ...
    [Migration("20260225160021_AgregarEsAlquilerACuentaPorCobrar")]
    partial class AgregarEsAlquilerACuentaPorCobrar
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PresupuestoFamiliarApp.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NombreUsuario = "admin",
                            PasswordHash = "$2a$11$QdzzGP0KOYIQ2IJDIodr9.DA7QAtYJ0dVgHOhOPlR/F5V7SLBPpoG",
                            Rol = "Administrador"
                        });
                });
